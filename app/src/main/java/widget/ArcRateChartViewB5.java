 ...
 * 重构版本1
 */
public class ArcRateChartViewB5 extends View {
    ...
    private static final String TAG = ArcRateChartViewB5.class.getSimpleName();
    ...
    public ArcRateChartViewB5(Context context) {
        this(context, null);
    }

    public ArcRateChartViewB5(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcRateChartViewB5(Context context, AttributeSet attrs, int defStyle) {
