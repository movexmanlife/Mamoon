...
public class ArcRateChartViewOk1 extends View {
    ...
    private Paint mMidRatePaint; // 画"大比率"那部分圆弧的画笔
    ...
    private int mMidRateColor = DEFAULT_MID_RATE_COLOR;
    ...
    public ArcRateChartViewOk1(Context context) {
        this(context, null);
    }

    public ArcRateChartViewOk1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcRateChartViewOk1(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mOval, 0, mRateAngleList.get(0), true, mBigRatePaint);
        canvas.drawArc(mOval, mRateAngleList.get(0) + 1, mRateAngleList.get(1), true,
                mMidRatePaint);
        canvas.drawArc(mOval, mRateAngleList.get(0) + mRateAngleList.get(1) + 1 + 1, mRateAngleList.get(2), true,
                mSmallRatePaint);
