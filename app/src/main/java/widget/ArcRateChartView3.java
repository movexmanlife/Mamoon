 ...
 */
public class ArcRateChartView3 extends View {
    ...
    private static final String TAG = ArcRateChartView3.class.getSimpleName();
    ...
    public ArcRateChartView3(Context context) {
        this(context, null);
    }

    public ArcRateChartView3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcRateChartView3(Context context, AttributeSet attrs, int defStyle) {
