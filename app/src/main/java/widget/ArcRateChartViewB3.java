 ...
 */
public class ArcRateChartViewB3 extends View {
    ...
    private static final String TAG = ArcRateChartViewB3.class.getSimpleName();
    ...
    public ArcRateChartViewB3(Context context) {
        this(context, null);
    }

    public ArcRateChartViewB3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcRateChartViewB3(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i <= mCurrentIndex; i++) {
            if (mCurrentIndex == 0) {
                ...
                if (mCurrentIndex == 1) {
                    ...
                    float ttt = mRateAngleList.get(totalCnt - 1 - 1);
                    float fff = 0;
                    ...
                    Log.e(TAG, "ppp: " + String.valueOf(progress) + ", " +
                            "实际角度: " + String.valueOf(progress - xxx) + ", " +
                            "ttt: " + String.valueOf(ttt) + ", " + "fff: "
                            + String.valueOf(fff) + ", " + String.valueOf(progress - fff + 1) + "~~~" + String.valueOf(progress - fff + 1 + aa));
                } else if (mCurrentIndex == 2) {
                    ...
                    Log.e(TAG + "aaaaa", String.valueOf(progress - fff1 + 1) + "~~~" + String.valueOf(progress - fff1 + 1 + aa1));
                    ...
                    Log.e(TAG + "bbbbb", String.valueOf(progress - fff + 1) + "~~~" + String.valueOf(progress - fff + 1 + aa));
                } else if (mCurrentIndex == 3) {
