...
public class MultiViewPagerOk extends ViewPager {
    /**
     * Maximum size.
     */
    ...
    public MultiViewPagerOk(Context context) {
        super(context);
        size = new Point();
        maxSize = new Point();
    }

    public MultiViewPagerOk(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
        size = new Point();
        maxSize = new Point();
