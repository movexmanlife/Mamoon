...
public class UserGuideActivity extends Activity {
	private ViewPager mDateTextPager;
	...
	public void initViewPager(){
		...
		mDateTextPager = (ViewPager)findViewById(R.id.pager);
      	mInnerPager = (ViewPager)findViewById(R.id.main_scrolllayout);
      	...
      	mInnerPager.setAdapter(mFramePageAdapter);
//      	mInnerPager.setOnPageChangeListener(mInnerPagerListener);
        ...
        mDateTextPager.setAdapter(mPageAdapter);
		mInnerPager.setFollowViewPager(mDateTextPager);
       // mDateTextPager.setOnPageChangeListener();
